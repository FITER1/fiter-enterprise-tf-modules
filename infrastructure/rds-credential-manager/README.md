...
module "credential_manager" {
  ...
  db_service_users = [
    {
      user        = "app_user"       # change to your application username (alphanumeric and underscores only)
      access_type = "readwrite"      # "readwrite" or "readonly"
      databases   = ["app_db"]       # change to the databases this user needs access to
    },
    {
      user        = "reporting_user"
...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_credential_manager"></a> [credential\_manager](#module\_credential\_manager) | terraform-aws-modules/lambda/aws | 7.21.1 |
